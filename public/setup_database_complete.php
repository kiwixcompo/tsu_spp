 ...
 * 
 * Access: https://staff.tsuniversity.ng/public/setup_database_complete.php
 * 
 * ============================================================================
 */
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .button { display: inline-block; background: #1e40af; color: white; padding: 12px 30px; border-radius: 5px; text-decoration: none; font-weight: 600; margin-top: 20px; border: none; cursor: pointer; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_setup'])) {
    ...
    try {
        ...
        echo '<div class="cred-item"><strong>Login URL:</strong> <a href="' . ($_ENV['APP_URL'] ?? 'https://staff.tsuniversity.ng/public') . '/login" target="_blank">' . ($_ENV['APP_URL'] ?? 'https://staff.tsuniversity.ng/public') . '/login</a></div>';
...
?>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 10px; font-size: 12px; color: #6b7280;">
                To delete: Remove <code>public/setup_database_complete.php</code> from your server
            </p>
        </div>
    </div>
</body>
