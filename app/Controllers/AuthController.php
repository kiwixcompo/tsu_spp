...
class AuthController extends Controller
{
    ...
    public function register(): void
    {
        ...
        $errors = $this->validate([
            'email_prefix' => 'required|min:3|max:50',
        ...
        // Validate staff ID prefix and number
        if (!in_array($staffPrefix, ['TSU/SP/', 'TSU/JP/'], true)) {
            $errors['staff_prefix'] = 'Invalid staff ID prefix';
        }
        if (empty($staffNumber) || !preg_match('/^[0-9]+$/', $staffNumber)) {
            $errors['staff_number'] = 'Staff ID should contain numbers only';
        }
        ...
        try {
            ...
            // Store faculty and department info for profile creation
